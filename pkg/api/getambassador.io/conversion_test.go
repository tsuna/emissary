...
import (
	...
	"github.com/datawire/ambassador/v2/pkg/api/getambassador.io/v1"
					...
					for throughAPIVersion := range testcases[typename] {
						...
						t.Run(testname, func(t *testing.T) {
							...
							for i := 0; i < listLen; i++ {
								...
								require.NoError(t, webhook.convertObject(inList.Index(i).Addr().Interface().(runtime.Object), midList.Index(i).Addr().Interface().(runtime.Object)))
							}
							...
							for i := 0; i < listLen; i++ {
								...
								require.NoError(t, webhook.convertObject(midList.Index(i).Addr().Interface().(runtime.Object), outList.Index(i).Addr().Interface().(runtime.Object)))
							}
